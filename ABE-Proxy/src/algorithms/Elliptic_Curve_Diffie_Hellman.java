...
import net.minidev.json.JSONObject;
import servlets.Cpabe_Information;
...
public class Elliptic_Curve_Diffie_Hellman {
	...
	private Logger logger = Logger.getLogger(Elliptic_Curve_Diffie_Hellman.class);
	...
	public void ECDH_ES(EPK_Info epk_info) {
		try{
			...
			logger.info("kp private: " + this.kp.getPrivate().toString());
