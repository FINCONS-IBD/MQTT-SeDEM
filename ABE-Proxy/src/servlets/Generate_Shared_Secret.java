...
//	        long startTimeDH = System.currentTimeMillis();
			...
			JSONObject jwk_obj = device_epk_info.getJwk();
	        Elliptic_Curve_Diffie_Hellman ecdh = new Elliptic_Curve_Diffie_Hellman(jwk_obj.getAsString("kty"), jwk_obj.getAsString("crv"));
...
//			JSONObject jwk_obj = ecdh.getJwk().toJSONObject();
...
//			JSON_Web_Key jwk = new JSON_Web_Key(ecdh.getKey_type(), ecdh.getCryptographic_curve(), ecdh.getXparameterB64url(), ecdh.getYparameterB64url());
			...
			EPK_Info proxy_epk_info_class = new EPK_Info(alg, enc, apu, apv, ecdh.getJwk());
