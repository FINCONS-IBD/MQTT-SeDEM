...
The library provide the high level algorithms and entities to perform AES or CPABE encryption and decryption operations and the methods to interact with the ABE-Proxy through the http/https protocol.
